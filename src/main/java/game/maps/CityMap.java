...
public class CityMap extends Map {
    public CityMap() {
        ...
        float fenceThickness = 3f; // this value doubles so 4 becomes 8-pixel thick
        ...
        roomWallSideRight.setZIndex(Game.ZIndex.MAP_DECORATIONS + 1);
        ...
        roomWallSideTurnRight.setZIndex(Game.ZIndex.MAP_DECORATIONS + 1);
        ...
        roomWallSideTurnLeft.setZIndex(Game.ZIndex.MAP_DECORATIONS + 1);
        ...
        layerLow.setZIndex(Game.ZIndex.MAP_FLOOR);
        ...
        layerMid.setZIndex(Game.ZIndex.MAP_DECORATIONS);
        ...
        layerDecor.setZIndex(Game.ZIndex.MAP_DECORATIONS);
        ...
        layerHigh.setZIndex(Game.ZIndex.MAP_HIGH);
